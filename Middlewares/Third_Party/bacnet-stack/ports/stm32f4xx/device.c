...
static const char *Device_Name_Default = "myPLC";
static uint32_t Database_Revision;
static BACNET_REINITIALIZED_STATE Reinitialize_State = BACNET_REINIT_IDLE;
static const char *Reinit_Password = "myPLC";
...
int Device_Read_Property_Local(BACNET_READ_PROPERTY_DATA *rpdata)
{
    ...
    switch ((int)rpdata->object_property) {
        case PROP_DESCRIPTION:
            characterstring_init_ansi(&char_string, "BACnet myPLC board");
            apdu_len =
                encode_application_character_string(&apdu[0], &char_string);
            break;
        case PROP_LOCATION:
            characterstring_init_ansi(&char_string, "BG");
            apdu_len =
                encode_application_character_string(&apdu[0], &char_string);
            break;
        ...
        case PROP_MODEL_NAME:
            characterstring_init_ansi(&char_string, "myPLC-mstp");
            apdu_len =
                encode_application_character_string(&apdu[0], &char_string);
            break;
